let prodInfo = {};
prodInfo.name = "USB PXN-0082 Arcade Joystick Wired Arcade Gaming Controller for Nintendo Switch PC Flight Games Joystick";
prodInfo.rating = "5 stars";
prodInfo.price = 19.99;
prodInfo.image =  [
